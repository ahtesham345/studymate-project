...
function GradeUser() {
  ...
  const findUserById = (userId) => {
    ...
    return grade || {}; // Return an empty object if user is not found
  };
  ...
  <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
    ...
    <td className="px-6 py-4">{currentUser.course_name}</td>
    <td className="px-6 py-4">{currentUser.calculated_grade}</td>

...
export default function DashboardComp() {
    ...
    const OpenSidebar = () => {
      ...
      useEffect(() => {
        ...
        // If redirected from login and isLoggedIn flag is true, show a welcome toast message
        if (isLoggedIn === 'true' && decodedToken && decodedToken.role === 'admin') {
          toast.success('Welcome to the Admin Dashboard!');
          // Clear the flag to avoid showing the toast on subsequent visits to the dashboard
          localStorage.removeItem('isLoggedIn');
        }
        else if (isLoggedIn === 'true' && decodedToken && decodedToken.role === 'student') {
